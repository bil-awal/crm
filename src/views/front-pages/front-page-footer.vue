          ...
          >
            <div class="mb-4 footer-form">
              ...
              <div class="text-body-1 footer-text mb-6">
                Most Powerful & Comprehensive CRM Administrator with Elegant Material Design & Unique Layouts.
              </div>
      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-4">
          <span class="d-flex align-center">
            ...
            {{ new Date().getFullYear() }}, CRM by
            <a
              href="https://pancaran-group.co.id"
              target="_blank"
          ...
          <div class="d-flex gap-x-2">
            <template
              v-for="(item, index) in [
                { title: 'facebook', icon: 'bxl-facebook', href: 'https://www.facebook.com/pancarangroupofficial' },
                { title: 'instagram', icon: 'bxl-instagram', href: 'https://www.instagram.com/pancarangroupofficial' },
                { title: 'linkedIn', icon: 'bxl-linkedin', href: 'https://www.linkedin.com/company/pancarangroup' },
                { title: 'youtube', icon: 'bxl-youtube', href: 'https://www.youtube.com/channel/UCaG-8WlfGD3P7UqlIQADupgp' },
              ]"
              :key="index"
            >
              <IconBtn
